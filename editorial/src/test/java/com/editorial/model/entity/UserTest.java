...
public class UserTest {
    ...
    @Test
    public void should_add_articleCorrect_to_journalist_list() {
        //given
        user = User.builder().articleCorrectsJournalist(new ArrayList<>()).build();
        articleCorrect = ArticleCorrect.builder().build();

        //when
        user.addArticleCorrectJournalist(articleCorrect);

        //then
        assertEquals(1, user.getArticleCorrectsJournalist().size());
        assertEquals(user, articleCorrect.getJournalist());
    }

    @Test
    public void should_create_new_articleCorrectsJournalist_list_if_null() {
        //given
        user = User.builder().build();
        articleCorrect = ArticleCorrect.builder().build();
        ...
        assertEquals(1, user.getArticleCorrectsJournalist().size());
        assertEquals(user, articleCorrect.getJournalist());
        assertEquals(articleCorrect, user.getArticleCorrectsJournalist().get(0));
        assertNotNull(user.getArticleCorrectsJournalist());
    }

    @Test
    public void should_not_add_null_articleCorrect_to_journalist_list() {
        // given
        user = User.builder().articleCorrectsJournalist(new ArrayList<>()).build();
        articleCorrect = null;
        ...
        // then
        assertEquals(0, user.getArticleCorrectsJournalist().size());
    }

    @Test
    public void should_remove_articleCorrect_from_journalist_list() {
        //given
        user = User.builder().build();
        articleCorrect = ArticleCorrect.builder().build();
        user.addArticleCorrectJournalist(articleCorrect);
        ...
        //when
        user.removeArticleCorrectJournalist(articleCorrect);

        //then
        assertEquals(0, user.getArticleCorrectsJournalist().size());
        assertNull(articleCorrect.getJournalist());
    }

    @Test
    public void should_not_remove_null_articleCorrect_from_journalist_list() {
        //given
        user = User.builder().build();
        articleCorrect = ArticleCorrect.builder().build();
        user.addArticleCorrectJournalist(articleCorrect);
        ...
        //when
        user.addArticleCorrectJournalist(null);

        //then
        assertEquals(1, user.getArticleCorrectsJournalist().size());
        assertNotNull(articleCorrect.getJournalist());
    }

    @Test
    public void should_not_remove_articleCorrect_from_journalist_list_if_null() {
        //given
        user = User.builder().build();
        articleCorrect = ArticleCorrect.builder().build();
        ...
        //then
        assertNull(user.getArticleCorrectsJournalist());
    }
