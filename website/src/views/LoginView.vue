...
.container-login100 {
  ...
  align-items: center;
  padding: 15px;
  background: -webkit-linear-gradient(to top,#add0ff, #e4f2ff);
  background: -o-linear-gradient(to top,#add0ff, #e4f2ff);
  background: -moz-linear-gradient(to top,#add0ff, #e4f2ff);
...
.login200-form-btn {
  font-size: 12px;
  color: #666666;
  background: rgba(149, 206, 255, 0.2);
}
