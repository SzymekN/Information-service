...
public class UserActionControllerTest {
    ...
    public void test_delete_user_for_admin() throws Exception {
        // given
        Long userId = 1L;
    ...
    public void test_delete_user_for_user() throws Exception {
        // given
        Long userId = 1L;
        HttpServletRequest request = mock(HttpServletRequest.class);
        User loggedUser = new User();
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void test_delete_user_no_admin() throws Exception {
        // given
        Long userId = 1L;
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void test_delete_user_for_editorial() throws Exception {
        // given
        Long userId = 1L;
    ...
    @Test
    @WithMockUser(roles = "ADMIN")
    public void test_edit_user_invalid_input() throws Exception {
        // given
        Long userId = 1L;
        UserRegistrationDto userRegistrationDto = new UserRegistrationDto();
        HttpServletRequest request = mock(HttpServletRequest.class);
    ...
    @Test
    @WithAnonymousUser
    public void test_for_anonymous_user() throws Exception {
        // given
        HttpServletRequest request = mock(HttpServletRequest.class);
        // when & then
        mockMvc.perform(delete("/client/actions/delete").with(csrf())
    ...
    public void test_for_not_allowed_user() throws Exception {
        // given
        HttpServletRequest request = mock(HttpServletRequest.class);
        // when & then
        mockMvc.perform(delete("/client/actions/delete").with(csrf())
